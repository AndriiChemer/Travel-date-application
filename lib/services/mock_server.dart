...
class MockServer {
  ...
  static List<UserModel> peopleList = [
    ...
    UserModel(id: "3", name: "Viktoriia Knyr", person: "Female", city: "Wroclaw", imageUrl: "https://scontent-waw1-1.xx.fbcdn.net/v/t1.0-9/60457709_864772787189123_3743945282803466240_n.jpg?_nc_cat=110&_nc_ohc=gTZApKPcEbUAQna2UNk3Y74FrmCtU4BXI59vVWQL5heNWY6W8pwYqyetA&_nc_ht=scontent-waw1-1.xx&oh=5b7fbf84f77bdc0aa18fe91f2da610c0&oe=5E83FAD9",
      state: 0, status: "Diamond", dateCreated: "2019.11.26", lastTimeOnline: "2019.11.26", lat: 51.099923, lng: 17.036116, description: description, isVerify: true, isHide: false, isOnline: false, createdAt: 123, lastVisitedAt: 123),
    UserModel(id: "4", name: "Maksym Lytvyn", person: "Male", city: "Wroclaw", imageUrl: "https://scontent-waw1-1.xx.fbcdn.net/v/t1.0-9/71813070_910727249327783_222159086056112128_n.jpg?_nc_cat=102&_nc_ohc=tGhwApO27W8AQkF9rJH620wLDEERszzT1hw-EUiHuCjkoJ-QvA-1YfSPQ&_nc_ht=scontent-waw1-1.xx&oh=08296a0a54da03239131e4693e36c617&oe=5E7CD684",
      state: 0, status: "Classic", dateCreated: "2019.11.26", lastTimeOnline: "2019.11.26", lat: 51.099923, lng: 17.036116, description: description, isVerify: false, isHide: false, isOnline: false, createdAt: 123, lastVisitedAt: 123),
    UserModel(id: "5", name: "Mariya", person: "Female", city: "Wroclaw", imageUrl: "https://scontent-waw1-1.xx.fbcdn.net/v/t1.0-9/72976549_961800860825744_7338113352209530880_n.jpg?_nc_cat=108&_nc_ohc=C4tbIMGX1CwAQkW2iObE0m8k01BiscdgJ893JuWK-hkluh5IbkdNZOyZg&_nc_ht=scontent-waw1-1.xx&oh=461e530ece4f15eea46838a1b74b7b18&oe=5E8C6F67",
      state: 0, status: "Diamond", dateCreated: "2019.11.26", lastTimeOnline: "2019.11.26", lat: 51.099923, lng: 17.036116, description: description, isVerify: false, isHide: false, isOnline: true, createdAt: 123, lastVisitedAt: 123),
  ...
  static List<MessageModel> messagesAndriiViktoriia = [
    MessageModel("1", 1575536726137, "Hello, how are you?", 0),
    MessageModel("2", 1575536736137, "Hi, fine:) And y?", 0),
    MessageModel("1", 1575536737137, "Fine, thanks:)", 0),
  ];

  static List<MessageModel> messagesVolodymyrAndrii = [
    MessageModel("2", 1575536726137, "Hello, how are you?", 0),
    MessageModel("2", 1575536736137, "Where are you?", 0),
  ];
