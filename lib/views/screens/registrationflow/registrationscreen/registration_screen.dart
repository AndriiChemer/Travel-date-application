...
//    }
  ...
  void _getCurrentLocation() async {
    ...
    LocationService().getLocation().then((location) {
      _getAddressFromLatLng(geolocator, location.latitude, location.longitude);
    });
  }

  void _getAddressFromLatLng(Geolocator geolocator, double latitude, double longitude) async {
    List<Placemark> places = await geolocator.placemarkFromCoordinates(
        latitude, longitude);
    Placemark place = places[0];

    //TODO send localization to database
    print("Place info:\n"
        "Name: ${place.name}\n "
